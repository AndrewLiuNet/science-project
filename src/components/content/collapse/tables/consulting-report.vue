  ...
  <div class="approve">
    ...
    <!-- 页面加载的表格 -->
      ...
      :row-style="{height: 40+'px'}"
        ...
        <el-table-column prop="report_name" label="报告名称" min-width="20%"   align="center"/>
        <el-table-column prop="author" label="作者" align="center" min-width="20%"  />
        <el-table-column prop="submitted_AttrOrginName" label="提交单位" align="center" min-width="20%"  />
        <el-table-column prop="publisher_AttrOrginId" label="刊用单位" align="center" min-width="20%"  />
        <el-table-column prop="publication_time" label="刊用时间" align="center" min-width="20%"  />
...
export default {
  ...
  methods: {
    ...
    // 获取咨询报告列表
    getResearList() {
     this.$axios.post("/api/yb1_Advisory_report/GetList",this.queryList).then((res) => {
